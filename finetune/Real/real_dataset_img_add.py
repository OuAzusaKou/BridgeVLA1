        ...
        for data_path in self.data_paths:
            for task in os.listdir(data_path):
                if task == "demonstration":
                    continue
                demonstration_dict={}
                demo_dir = os.path.join(data_path, "demonstration")
                        ...
                        if ext.lower() in [".png", ".jpg", ".jpeg", ".bmp", ".tiff", ".webp"]:
                            ...
                            try:
                                with open(fpath, 'rb') as f:
                                    ...
                                    demonstration_dict[base] = arr
                            except Exception as e:
                                print(f"Failed to load demo image {fpath}: {e}")
                ...
                if os.path.isdir(task_path): 
                    for episode_num in tqdm(os.listdir(task_path)):
                        ...
                        for step in range(num_steps - 1):
                            ...
                            if 'coke' in instruction:
                                img_demonstration = demonstration_dict['cola']
                                instruction = "put the thing represented by the image on the top shelf"
                            elif 'RedBull' in instruction:
                                img_demonstration = demonstration_dict['redbull']
                                instruction = "put the thing represented by the image on the top shelf"
                            elif 'soda' in instruction:
                                img_demonstration = demonstration_dict['soda']
                                instruction = "put the thing represented by the image on the top shelf"
                            else:
                                raise ValueError(f"instruction {instruction} is not supported")

                            sample["img_demonstration"] = img_demonstration
